...
export default {
  ...
  data() {
    return {
      toRotate: ["Welcome to My personal website."],
      period: 2000,
      txt: "",
      loopNum: 0,
      isDeleting: false,
...
.typewrite > .wrap {
  border-right: 0.08em solid #0a0a0a;
}
...
.pict {
  box-shadow: 0px 0px 73px -9px rgba(89, 184, 196, 0.655);
  -webkit-box-shadow: 0px 0px 73px -9px rgba(57, 139, 145, 0.44);
  -moz-box-shadow: 0px 0px 73px -9px rgba(60, 125, 133, 0.44);
}
