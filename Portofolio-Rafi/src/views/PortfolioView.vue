      ...
      items: [
        {
          ...
          imageUrl: "tableu",
          status:
            "Dataset from Kaggle, understanding a time series of COVID-19 pandemic events in Indonesia, from the country level to the province level.",
          tech: "Tableau",
          github: "null",
          demo: "null",
        },
        {
          ...
          imageUrl: "report",
          status:
            "Dataset from BigQuery, This sales dashboard is designed to provide a comprehensive overview of sales performance in various periods.",
          tech: "Looker Studio",
          github: "null",
        ...
        },
        {
          ...
          name: "Journey Mate",
          imageUrl: "heppo",
          status: "Information system that helps students to focus.",
